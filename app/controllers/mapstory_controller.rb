class MapstoryController < ApplicationController
	...
	def callback
		...
		if params[:code]
			@token = client.auth_code.get_token(params[:code], :redirect_uri => 'http://warper.mapstory.org/oauth_consumers/mapstory/callback')
		end
	...
	def authorize
		...
		@auth_url = client.auth_code.authorize_url(:redirect_uri => 'http://warper.mapstory.org/oauth_consumers/mapstory/callback')
